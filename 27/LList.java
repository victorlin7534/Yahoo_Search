...
{ 
	...
	Iterator<T> output = new MyIterator();
	return output;
    }
	...
	public void remove() 
	{
	    ...
	    //A: The remove function of an iterator should remove the last element returned through next(). These lines ensure that next() was called before remove() attempts to remove anything.
	    if ( ! _okToRemove )
